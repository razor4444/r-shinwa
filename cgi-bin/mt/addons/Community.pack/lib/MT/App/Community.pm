...
#
# $Id: Community.pm 116787 2009-12-16 06:00:51Z auno $
...
sub _return_scores {
    my $app = shift;
    my %param = @_;
    my ( $blog_id, $ids, $ds, $ns )
        = @param{qw( blog_id object_id datasource namespace )};
    $ns ||= NAMESPACE();
...
sub vote {
    ...
    $obj->set_score( NAMESPACE(), $user, $value, $overwrite )
