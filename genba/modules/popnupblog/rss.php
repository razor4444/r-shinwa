<?php
// $Id: rss.php,v 3.0 2006/12/04 16:05:10 yoshis Exp $
...
if($params['blogid'] && $params['blogid'] > 0){
	...
	if (is_array($blogList)) {
		...
		$tpl->assign("_MD_POPNUPBLOG_TITLE_SUFFIX",to_urf8(htmlspecialchars(_MD_POPNUPBLOG_TITLE_SUFFIX, ENT_QUOTES)));
		$tpl->assign("_MD_POPNUPBLOG_TITLE_PREFIX",to_urf8(htmlspecialchars(_MD_POPNUPBLOG_TITLE_PREFIX, ENT_QUOTES)));
	}
