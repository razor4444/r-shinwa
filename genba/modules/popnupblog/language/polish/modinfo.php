...
define('_MI_POPNUPBLOG_REWRITE_DESC', 'U¿ytkownik mo¿e u¿yæ adresu url from/modules/popnupblog/view/index.php?uid=1 do /modules/popnupblog/view/1.html (tylko dla ekspertów)');
...
define('_MI_POPNUPBLOG_TRACKBACK_DESC', 'W³±cz funkcjê TrackBack');
define('_MI_POPNUPBLOG_UNUSE_REWRITE', 'Nie u¿ywaj rewrite');
define('_MI_POPNUPBLOG_APPL_DENY', 'Odmowa');
define('_MI_POPNUPBLOG_CONFIG_RSS_DEF', 'U¿ytkownik blogów mo¿e pisaæ');
...
define('_MI_POPNUPBLOG_FILECHRSET', 'Sposób kodowania za³±czanych plików');
...
define("_MI_POPNUPBLOG_ACTVTYPE","Wybierz sposób aktywowania nowo zak³adanych blogów");
define("_MI_POPNUPBLOG_AUTOACTV","Aktywacja automatyczna");
define("_MI_POPNUPBLOG_ADMINACTV","Aktywacja przez administratora");
define("_MI_POPNUPBLOG_NEWUNOTIFY","Powiadomiæ e-mailem o zarejestrowaniu nowego bloga?");
define("_MI_POPNUPBLOG_SHOWNAME","Zamieniaj nazwê u¿ytkownika na jego prawdziwe imiê i nazwisko");
...
define ('_MI_POPNUPBLOG_BLOG_NOTIFYDSC', 'Opcje powiadomieñ odnosz±ce siê do tego bloga.');

define ('_MI_POPNUPBLOG_GLOBAL_NOTIFY', 'Globalne');
define ('_MI_POPNUPBLOG_GLOBAL_NOTIFYDSC', 'Globalne opcje powiadomieñ o blogu.');
...
define ('_MI_POPNUPBLOG_BLOG_NEWPOST_NOTIFYDSC', 'Otrzymasz powiadomienie, gdy nowy wpis pojawi siê na tym blogu.');
...
define ('_MI_POPNUPBLOG_GLOBAL_NEWPOST_NOTIFYDSC', 'Otrzymasz powiadomienie, gdy pojawi siê jakikolwiek nowy wpis.');
...
define ('_MI_POPNUPBLOG_GLOBAL_NEWFULLPOST_NOTIFYCAP', 'Powiadamiaj mnie o wszelkich nowych wpisach (do³±cz do wiadomo¶ci pe³n± tre¶æ wpisu).');
