...
define ('_MI_POPNUPBLOG_1_LINE',' НедавнЋо обновиЋл blog ');
define ('_MI_POPNUPBLOG_CONF_DESC',' Описание ');
define ('_MI_POPNUPBLOG_TRACKBACK',' TrackBack ');
define ('_MI_POPNUPBLOG_REWRITE_TITLE',' ИспользуйтЋе АпачЋа, перезаписывают двигателЋь ');
define ('_MI_POPNUPBLOG_NAME',' PopnupBLOG ');
define ('_MI_POPNUPBLOG_DESC',' Popnup Blog ');
define ('_MI_POPNUPBLOG_UNUSE_UPDATE_PING',' НеиспользуйтЋе утилитЋу ping модификациЋи ');
define ('_MI_POPNUPBLOG_UNUSE_TRACKBACK',' НеиспользуйтЋе trackback ');
define ('_MI_POPNUPBLOG_APPL_WAITING_TITLE',' PopnupBlog НовоЋе Приложение ');
define ('_MI_POPNUPBLOG_NAME_BIG_BLOCK',' PopnupBlog ');
define ('_MI_POPNUPBLOG_USE_REWRITE',' ИспользуйтЋе перезапись ');
define ('_MI_POPNUPBLOG_UPDATE_PING',' ИспользуйтЋе утилитЋу ping модификациЋи ');
define ('_MI_POPNUPBLOG_1_LINE_DESC',' 1 блок представлениЋя(вида) линиЋи ');
define ('_MI_POPNUPBLOG_REWRITE_DESC',' Пользователь можеЋт использовать blog url from/modules/popnupblog/view/index.php? uid=1 Ћк/modules/popnupblog/view/1.html (только эксперЋт) ');
define ('_MI_POPNUPBLOG_APPL_WAITING',' НовоЋе Приложение ');
define ('_MI_POPNUPBLOG_UPDATE_PING_DESC',' ИспользуйтЋе утилитЋу ping модификациЋи ');
define ('_MI_POPNUPBLOG_WRITE',' Пишите Blog ');
define('_MI_POPNUPBLOG_PREFERENCE', 'Preference');
define('_MI_POPNUPBLOG_APPLY', 'New Blog');
define ('_MI_POPNUPBLOG_TRACKBACK_DESC',' ДопуститЋе ОсобенностЋи TrackBack ');
define ('_MI_POPNUPBLOG_UNUSE_REWRITE',' НеиспользуйтЋе перезапись ');
define ('_MI_POPNUPBLOG_APPL_DENY',' неразрешитЋе ');
define ('_MI_POPNUPBLOG_CONFIG_RSS_DEF',' Popnup blog пользователь можеЋт писать ');
define ('_MI_POPNUPBLOG_USE_TRACKBACK',' ИспользуйтЋе trackback ');
define ('_MI_POPNUPBLOG_APPL_ALLOW',' разрешитЋе ');
define ('_MI_POPNUPBLOG_APPL_OK',' ПозволитЋе приложению длЋя пользоватеЋлЋя ');
define ('_MI_POPNUPBLOG_USE_UPDATE_PING',' ИспользуйтЋе утилитЋу ping модификациЋи ');
define ('_MI_POPNUPBLOG_CONFIG_RSS_DESC',' Описание длЋя этогЋо blog на подаче rss ');
