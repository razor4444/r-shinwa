<?php
// $Id: emailalias.php,v 3.0 2006/12/09 17:07:08 yoshis Exp $
//  ------------------------------------------------------------------------ //
...
class emailalias {
	function get_uid_bymail($bid,$pid,$emailalias){
		global $xoopsDB;
		$sql = "SELECT uid FROM ".PBTBL_EMAILALIAS." Where blogid=$bid and public=$pid and email='$emailalias' limit 1";
